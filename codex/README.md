...
This directory records the design and implementation work carried out with Codex.
Application code, API contracts, migrations, and tests belong in their normal project
locations; Codex working documents belong here.
